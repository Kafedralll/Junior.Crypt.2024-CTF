Условие. В текстовом файле находится отзыв о посещении гродненского ресторана. И, одновременно, в нем скрыт флаг. Найдите этот флаг.

==========================

Решение. Открываем файл в Hex-editir'e (Например, https://hexed.it/). Зачечаем, что текст в кодировке UTF-8, а пробелы в нем представлены в двух видах: как 0x20 или как 0x0020.
